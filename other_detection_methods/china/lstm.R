...
stocks <- read_xlsx("/home/diego/Documentos/datascience/time-series/volatility/avaliacao-experimental/mestrado/files/Base de Dados Consolidada base line.xlsx",sheet="China")
method_emd <- "CEEMD"
...
file <- sprintf("metodos-harbinger/files/stocks-soft-lstm-china-exp1.csv" )
